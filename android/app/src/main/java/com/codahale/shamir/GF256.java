...
class GF256 {
  ...
  static byte mul(byte a, byte b) {
    ...
    return EXP[byteToUnsignedInt(LOG[byteToUnsignedInt(a)]) + byteToUnsignedInt(LOG[byteToUnsignedInt(b)])];
  }
  ...
  static byte div(byte a, byte b) {
    ...
    return mul(a, EXP[255 - byteToUnsignedInt(LOG[byteToUnsignedInt(b)])]);
  }
