...
public class ShareStorageHandler {
...
//     * @param message
//     */
//    public static void storeMessage(Context context, Message message) throws JSONException{
...
//        System.out.println("Storing " +  (edit.commit() ? "succesfull" : "failed"));
//    }
}
